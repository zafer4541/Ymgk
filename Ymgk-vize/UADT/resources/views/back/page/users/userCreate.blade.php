...
@section('headingTitle','Kullanıcı Ekleme Sayfası')
@section('css')
@section('content')
    @if(session('addUsersWarning'))
        <script>
            Swal.fire({
                icon: 'error',
                title: '{{(session('addUsersWarning'))}}',
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{route('back.users.store')}}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <h5 class="opacity-75" style="color:rgb(96, 112, 128)">Kullanıcı Ekleme Paneli</h5>
                                            ...
                                            <div class="row pt-5">
                                                ...
                                                <div class="col-10 pl-4 pt-md-3">
                                                    ...
                                                    <div class="form-group col-6 float-end">
                                                        ...
                                                        <input type="text" placeholder="Ad-Soyad" name="name" class="form-control" value="">
                                                        <br>
                                                    </div>

                                                    <div class="form-group col-6 float-start">
                                                        <label>E-mail Adresi</label>
                                                        <input type="email" placeholder="E-mail" name="email" class="form-control" value="">
                                                    </div>
                                                    <div class="form-group col-6 float-end">
                                                        <label>Şifre</label>
                                                    ...
                                                    <div class="form-group col-6 float-start">
                                                        ...
                                                        <input type="text" name="company_name" placeholder="Firmanın İsmi" class="form-control" value=""><br>
                                                    </div>
                                                    <div class="form-group col-6 float-end">
                                                        <label>Firmanın Adresi</label>
                                                        <input type="text" name="company_address" placeholder="Firmanın Adresi" class="form-control" value=""><br>
                                                    </div>
                                                    <div class="form-group col-6 float-start">
                                                        <label>Firmanın Ülkesi</label>
                                                        <select name="country" id="country" onchange="getCities(this)" class="form-select">
                                                            <option  value="" selected>Ülke</option>
                                                    ...
                                                    <div class="form-group col-6 float-start">
                                                        ...
                                                        <input type="text" name="company_phone" placeholder="Firmanın Telefon" id="company_phone" class="form-control" value=""><br>
                                                    </div>
                                                    <div class="form-group col-6 float-end">
                                                        <label>Firmanın Faxı</label>
                                                        <input type="text" name="company_fax" id="company_fax" placeholder="Firmanın Faxı" class="form-control" value=""><br>
                                                    </div>
                                                    <div class="form-group col-6 float-start">
                                                    ...
                                                    <div class="form-group col-6 float-end">
                                                        ...
                                                        <input type="text" id="foundation_year" name="company_foundation_year" placeholder="Firmanın Kuruluş Yılı" class="form-control" maxlength="4" value=""><br>
                                                    </div>
                                                    <div class="form-group col-6 float-start">
                                                        <br>
                                                        <label>Firmanın Sermayesi(TL)</label>
                                                        <input type="number" name="company_capital" placeholder="Sermaye(TL)"  class="form-control" value=""><br>
                                                    </div>
                                                    <div class="form-group col-6 float-end">
                                                        <label>Firmanın Vergi Dairesi Ve Numarası</label>
                                                        <input type="text" name="company_tax_administration" placeholder="Vergi Dairesi Ve Numarası" class="form-control" value=""><br>
                                                    </div>
                                                    <div class="form-group col-6 float-start">
                                                        <label>Firmanın Sahip Olduğu Kapalı Alan(m²)</label>
                                                        <input type="number" name="company_closed_area" placeholder="Kapalı Alan" class="form-control" value=""><br>
                                                    </div>
                                                    <div class="form-group col-6 float-end">
                                                        <label>Firmanın Sahip Olduğu Açık Alan(m²)</label>
                                                        <input type="number" name="company_open_area" placeholder="Açık Alan" class="form-control" value=""><br>
                                                    </div>
                                                    <div class="form-group col-6 float-start">
                                                        <label>Firmada Çalışan Kişi Sayısı</label>
                                                        <input type="number" name="company_number_employees" placeholder="Çalışan Kişi Sayısı" class="form-control" value=""><br>
                                                    </div>
                                                    <div class="form-group col-6 float-start">
                                                    ...
                                                    <div class="form-group col-6 float-end">
                                                        ...
                                                        <textarea type="text" name="company_document" rows = "5" cols = "60"  class="form-control" value=""></textarea><br>
                                                    </div>
                                                    <div class="form-group col-6 float-start">
                                                        <label>Firmanın Açıklaması</label>
                                                        <textarea type="textarea" name="company_description" rows = "5" cols = "60" class="form-control" value=""> </textarea><br>
                                                    </div>   <br>
                                                </div>
                                            </div>
                                        </div>
