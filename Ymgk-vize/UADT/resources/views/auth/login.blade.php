    ...
    <div class="row h-100">
        <div class="col-lg-5 col-12">
            <div id="auth-left">
                ...
                <p class="auth-subtitle mb-5">Dış Ticaret Hızlandırma Merkezi</p>
                @if($errors->any())
                ...
                <form  action="{{ route('login') }}"  method="POST" enctype="multipart/form-data" >
                    ...
                    <button class="btn btn-primary btn-block btn-lg shadow-lg mt-5 log_button">Giriş Yap</button>
                </form>
                <div class="text-center mt-5 text-lg fs-4">
                    <p class='text-gray-600'>Şifrenizi Hatırlamıyor Musunuz? <a   href="{{ route('password.request') }}" class="font-bold"><br>Şifremi Unuttum</a>.</p>
                </div>
            </div>
        </div>
